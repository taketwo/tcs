...
public:
  ...
  instantiate (int argc, char** argv)
  {
    ...
    ewc->template addTerm<XYZ> (xyz_influence_, EdgeWeightComputer::NORMALIZATION_GLOBAL);
    ...
    ewc->template addTerm<RGB> (color_influence_, EdgeWeightComputer::NORMALIZATION_LOCAL);
